...
void realGame(const std::vector<Util::ReferenceCount<Paintown::Object>> & players, const Level::LevelInfo & levelInfo);

/* run a multi-player local game */
void realGameLocal(const std::vector<Util::ReferenceCount<Paintown::Object>> & futurePlayers, const Level::LevelInfo & levelInfo);
