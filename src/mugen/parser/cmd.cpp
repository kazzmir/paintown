...
Result rule_section(Stream & stream, const int position){
    ...
    RuleTrace trace_peg_88(stream, "section");
    int myposition = position;
                ...
                do{
                    Result result_peg_9(result_peg_2.getPosition());
                    {
                    
                        {
                                ...
                                result_peg_9.reset();
                                do{
                                    Result result_peg_52(result_peg_9.getPosition());
                                    {
                                        int position_peg_55 = result_peg_52.getPosition();
                                        
                                        {
                                            int position_peg_66 = result_peg_52.getPosition();
                                            ...
                                            for (int i = 0; i < 1; i++){
                                                if (compareChar(" "[i], stream.get(result_peg_52.getPosition()))){
                                                    ...
                                                    result_peg_52.setPosition(position_peg_66);
                                                    goto out_peg_67;
                                                }
                                            }
                                        ...
                                        out_peg_67:
                                        {
                                            int position_peg_69 = result_peg_52.getPosition();
                                            ...
                                            for (int i = 0; i < 1; i++){
                                                if (compareChar("\t"[i], stream.get(result_peg_52.getPosition()))){
                                                    ...
                                                    result_peg_52.setPosition(position_peg_69);
                                                    goto out_peg_70;
                                                }
                                            }
                                        ...
                                        goto success_peg_64;
                                        out_peg_70:
                                        result_peg_52.setPosition(position_peg_55);
                                        goto out_peg_63;
                                        success_peg_64:
                                        ;
                                    ...
                                    out_peg_63:
                                    {
                                        int position_peg_72 = result_peg_52.getPosition();
                                        
                                        {
                                            int position_peg_83 = result_peg_52.getPosition();
                                            ...
                                            for (int i = 0; i < 1; i++){
                                                if (compareChar("\n"[i], stream.get(result_peg_52.getPosition()))){
                                                    ...
                                                    result_peg_52.setPosition(position_peg_83);
                                                    goto out_peg_84;
                                                }
                                            }
                                        ...
                                        out_peg_84:
                                        {
                                            int position_peg_86 = result_peg_52.getPosition();
                                            
                                            result_peg_52.setValue(Value((void*) "\r"));
                                            for (int i = 0; i < 1; i++){
                                                if (compareChar("\r"[i], stream.get(result_peg_52.getPosition()))){
                                                    result_peg_52.nextPosition();
                                                } else {
                                                    result_peg_52.setPosition(position_peg_86);
                                                    goto out_peg_87;
                                                }
                                            }
                                        ...
                                        goto success_peg_81;
                                        out_peg_87:
                                        result_peg_52.setPosition(position_peg_72);
                                        goto out_peg_80;
                                        success_peg_81:
                                        ;
                                    ...
                                    success_peg_53:
                                    ;
                                    result_peg_9.addResult(result_peg_52);
                                } while (true);
                                loop_peg_51:
                                ;
...
Result rule_assignment(Stream & stream, const int position){
    ...
    RuleTrace trace_peg_605(stream, "assignment");
    int myposition = position;
    ...
    Result result_peg_2(myposition);
        ...
        
        {
            ...
            result_peg_51.setValue(Value((void*) "guardsound"));
                for (int i = 0; i < 10; i++){
                    if (compareCharCase("guardsound"[i], stream.get(result_peg_51.getPosition()))){
                        result_peg_51.nextPosition();
                    } else {
                        goto out_peg_55;
                    }
            ...
            int save_peg_102 = result_peg_51.getPosition();
                
                result_peg_51.setValue(Value((void*) "s"));
                for (int i = 0; i < 1; i++){
                    if (compareCharCase("s"[i], stream.get(result_peg_51.getPosition()))){
                        result_peg_51.nextPosition();
                    } else {
                        
                        result_peg_51 = Result(save_peg_102);
                        result_peg_51.setValue(Value((void*) 0));
                        
                    }
                }
                own = result_peg_51.getValues();
            
            
            
            result_peg_51 = rule_expr_c(stream, result_peg_51.getPosition());
                if (result_peg_51.error()){
                    goto out_peg_55;
                }
                item = result_peg_51.getValues();
            
            
            
            {
                    int position_peg_107 = result_peg_51.getPosition();
                    
                    result_peg_51.reset();
                    do{
                        Result result_peg_118(result_peg_51.getPosition());
                        {
                        ...
                        success_peg_119:
                        ;
                        result_peg_51.addResult(result_peg_118);
                    } while (true);
                    loop_peg_117:
                    ;
            ...
            {
                    int position_peg_130 = result_peg_51.getPosition();
                    
                    result_peg_51.reset();
                    do{
                        Result result_peg_141(result_peg_51.getPosition());
                        {
                        ...
                        success_peg_142:
                        ;
                        result_peg_51.addResult(result_peg_141);
                    } while (true);
                    loop_peg_140:
                    ;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_152 = stream.getLineInfo(result_peg_150.getPosition());
                line = &line_info_peg_152;
            
            
            
            result_peg_150.setValue(Value((void*) "sparkno"));
                for (int i = 0; i < 7; i++){
                    if (compareCharCase("sparkno"[i], stream.get(result_peg_150.getPosition()))){
            ...
            {
                    int position_peg_158 = result_peg_150.getPosition();
                    
                    result_peg_150.reset();
                    do{
                        Result result_peg_169(result_peg_150.getPosition());
                        {
                            int position_peg_172 = result_peg_169.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_169.getPosition()))){
                                    ...
                                    result_peg_169.setPosition(position_peg_172);
                                    goto out_peg_173;
                                }
                            }
                        ...
                        success_peg_170:
                        ;
                        result_peg_150.addResult(result_peg_169);
                    } while (true);
                    loop_peg_168:
                    ;
            ...
            {
                    int position_peg_181 = result_peg_150.getPosition();
                    
                    result_peg_150.reset();
                    do{
                        Result result_peg_192(result_peg_150.getPosition());
                        {
                            int position_peg_195 = result_peg_192.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_192.getPosition()))){
                                    ...
                                    result_peg_192.setPosition(position_peg_195);
                                    goto out_peg_196;
                                }
                            }
                        ...
                        out_peg_196:
                        {
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_192.getPosition()))){
                                    ...
                                    result_peg_192.setPosition(position_peg_198);
                                    goto out_peg_199;
                                }
                            }
                        ...
                        success_peg_193:
                        ;
                        result_peg_150.addResult(result_peg_192);
                    } while (true);
                    loop_peg_191:
                    ;
            ...
            int save_peg_201 = result_peg_150.getPosition();
                
                result_peg_150.setValue(Value((void*) "s"));
                for (int i = 0; i < 1; i++){
                    if (compareCharCase("s"[i], stream.get(result_peg_150.getPosition()))){
                        result_peg_150.nextPosition();
                    } else {
                        
                        result_peg_150 = Result(save_peg_201);
                        result_peg_150.setValue(Value((void*) 0));
                        
                    }
                }
                own = result_peg_150.getValues();
            
            
            
            result_peg_150 = rule_expr(stream, result_peg_150.getPosition());
                if (result_peg_150.error()){
                    goto out_peg_154;
                }
                exp = result_peg_150.getValues();
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_150;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_205 = stream.getLineInfo(result_peg_203.getPosition());
                line = &line_info_peg_205;
            
            
            
            result_peg_203.setValue(Value((void*) "anim"));
                for (int i = 0; i < 4; i++){
                    if (compareCharCase("anim"[i], stream.get(result_peg_203.getPosition()))){
            ...
            {
                    int position_peg_211 = result_peg_203.getPosition();
                    
                    result_peg_203.reset();
                    do{
                        Result result_peg_222(result_peg_203.getPosition());
                        {
                            int position_peg_225 = result_peg_222.getPosition();
                            
                            result_peg_222.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_222.getPosition()))){
                                    result_peg_222.nextPosition();
                                } else {
                                    result_peg_222.setPosition(position_peg_225);
                                    goto out_peg_226;
                                }
                            }
                        ...
                        out_peg_226:
                        {
                            int position_peg_228 = result_peg_222.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_222.getPosition()))){
                                    ...
                                    result_peg_222.setPosition(position_peg_228);
                                    goto out_peg_229;
                                }
                            }
                        ...
                        success_peg_223:
                        ;
                        result_peg_203.addResult(result_peg_222);
                    } while (true);
                    loop_peg_221:
                    ;
            ...
            result_peg_203.setValue(Value((void*) "="));
                for (int i = 0; i < 1; i++){
            ...
            {
                    int position_peg_234 = result_peg_203.getPosition();
                    
                    result_peg_203.reset();
                    do{
                        Result result_peg_245(result_peg_203.getPosition());
                        {
                            int position_peg_248 = result_peg_245.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_245.getPosition()))){
                                    ...
                                    result_peg_245.setPosition(position_peg_248);
                                    goto out_peg_249;
                                }
                            }
                        ...
                        success_peg_246:
                        ;
                        result_peg_203.addResult(result_peg_245);
                    } while (true);
                    loop_peg_244:
                    ;
            ...
            int save_peg_254 = result_peg_203.getPosition();
                
                result_peg_203.setValue(Value((void*) "s"));
                for (int i = 0; i < 1; i++){
                    if (compareCharCase("s"[i], stream.get(result_peg_203.getPosition()))){
                        result_peg_203.nextPosition();
                    } else {
                        
                        result_peg_203 = Result(save_peg_254);
                        result_peg_203.setValue(Value((void*) 0));
                        
                    }
                }
                own = result_peg_203.getValues();
            
            
            
            result_peg_203 = rule_expr(stream, result_peg_203.getPosition());
                if (result_peg_203.error()){
                    goto out_peg_207;
                }
                exp = result_peg_203.getValues();
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_203;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_258 = stream.getLineInfo(result_peg_256.getPosition());
                line = &line_info_peg_258;
            
            
            
            result_peg_256.setValue(Value((void*) "hitsound"));
                for (int i = 0; i < 8; i++){
                    if (compareCharCase("hitsound"[i], stream.get(result_peg_256.getPosition()))){
            ...
            {
                    int position_peg_264 = result_peg_256.getPosition();
                    
                    result_peg_256.reset();
                    do{
                        Result result_peg_275(result_peg_256.getPosition());
                        {
                            int position_peg_278 = result_peg_275.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_275.getPosition()))){
                                    ...
                                    result_peg_275.setPosition(position_peg_278);
                                    goto out_peg_279;
                                }
                            }
                        ...
                        out_peg_279:
                        {
                            int position_peg_281 = result_peg_275.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_275.getPosition()))){
                                    ...
                                    result_peg_275.setPosition(position_peg_281);
                                    goto out_peg_282;
                                }
                            }
                        ...
                        success_peg_276:
                        ;
                        result_peg_256.addResult(result_peg_275);
                    } while (true);
                    loop_peg_274:
                    ;
            ...
            result_peg_256.setValue(Value((void*) "="));
                for (int i = 0; i < 1; i++){
            ...
            {
                    int position_peg_287 = result_peg_256.getPosition();
                    
                    result_peg_256.reset();
                    do{
                        Result result_peg_298(result_peg_256.getPosition());
                        {
                            int position_peg_301 = result_peg_298.getPosition();
                            
                            result_peg_298.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_298.getPosition()))){
                                    result_peg_298.nextPosition();
                                } else {
                                    result_peg_298.setPosition(position_peg_301);
                                    goto out_peg_302;
                                }
                            }
                        ...
                        out_peg_302:
                        {
                            int position_peg_304 = result_peg_298.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_298.getPosition()))){
                                    ...
                                    result_peg_298.setPosition(position_peg_304);
                                    goto out_peg_305;
                                }
                            }
                        ...
                        success_peg_299:
                        ;
                        result_peg_256.addResult(result_peg_298);
                    } while (true);
                    loop_peg_297:
                    ;
            ...
            int save_peg_307 = result_peg_256.getPosition();
                
                result_peg_256.setValue(Value((void*) "s"));
                for (int i = 0; i < 1; i++){
                    if (compareCharCase("s"[i], stream.get(result_peg_256.getPosition()))){
                        result_peg_256.nextPosition();
                    } else {
                        
                        result_peg_256 = Result(save_peg_307);
                        result_peg_256.setValue(Value((void*) 0));
                        
                    }
                }
                own = result_peg_256.getValues();
            
            
            
            result_peg_256 = rule_expr_c(stream, result_peg_256.getPosition());
                if (result_peg_256.error()){
                    goto out_peg_260;
                }
                exp1 = result_peg_256.getValues();
            
            
            
            {
                    int position_peg_312 = result_peg_256.getPosition();
                    
                    result_peg_256.reset();
                    do{
                        Result result_peg_323(result_peg_256.getPosition());
                        {
                        ...
                        success_peg_324:
                        ;
                        result_peg_256.addResult(result_peg_323);
                    } while (true);
                    loop_peg_322:
                    ;
            ...
            {
                    int position_peg_335 = result_peg_256.getPosition();
                    
                    result_peg_256.reset();
                    do{
                        Result result_peg_346(result_peg_256.getPosition());
                        {
                        ...
                        success_peg_347:
                        ;
                        result_peg_256.addResult(result_peg_346);
                    } while (true);
                    loop_peg_345:
                    ;
            ...
            result_peg_256 = rule_expr(stream, result_peg_256.getPosition());
                if (result_peg_256.error()){
                    goto out_peg_260;
                }
                exp2 = result_peg_256.getValues();
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_256;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_357 = stream.getLineInfo(result_peg_355.getPosition());
                line = &line_info_peg_357;
            
            
            
            result_peg_355 = rule_identifier(stream, result_peg_355.getPosition());
                if (result_peg_355.error()){
                    goto out_peg_359;
                }
                name = result_peg_355.getValues();
            
            
            
            {
                    int position_peg_363 = result_peg_355.getPosition();
                    
                    result_peg_355.reset();
                    do{
                        Result result_peg_374(result_peg_355.getPosition());
                        {
                            int position_peg_377 = result_peg_374.getPosition();
                            
                            result_peg_374.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_374.getPosition()))){
                                    result_peg_374.nextPosition();
                                } else {
                                    result_peg_374.setPosition(position_peg_377);
                                    goto out_peg_378;
                                }
                            }
                                
                        }
                        goto success_peg_375;
                        out_peg_378:
                        {
                            int position_peg_380 = result_peg_374.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_374.getPosition()))){
                                    ...
                                    result_peg_374.setPosition(position_peg_380);
                                    goto out_peg_381;
                                }
                            }
                        ...
                        success_peg_375:
                        ;
                        result_peg_355.addResult(result_peg_374);
                    } while (true);
                    loop_peg_373:
                    ;
            ...
            result_peg_355.setValue(Value((void*) "="));
                for (int i = 0; i < 1; i++){
            ...
            {
                    int position_peg_386 = result_peg_355.getPosition();
                    
                    result_peg_355.reset();
                    do{
                        Result result_peg_397(result_peg_355.getPosition());
                        {
                            int position_peg_400 = result_peg_397.getPosition();
                            
                            result_peg_397.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_397.getPosition()))){
                                    result_peg_397.nextPosition();
                                } else {
                                    result_peg_397.setPosition(position_peg_400);
                                    goto out_peg_401;
                                }
                            }
                                
                        }
                        goto success_peg_398;
                        out_peg_401:
                        {
                            int position_peg_403 = result_peg_397.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_397.getPosition()))){
                                    ...
                                    result_peg_397.setPosition(position_peg_403);
                                    goto out_peg_404;
                                }
                            }
                        ...
                        success_peg_398:
                        ;
                        result_peg_355.addResult(result_peg_397);
                    } while (true);
                    loop_peg_396:
                    ;
            ...
            result_peg_355 = rule_expr(stream, result_peg_355.getPosition());
                if (result_peg_355.error()){
                    goto out_peg_359;
                }
                exp = result_peg_355.getValues();
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_355;
        ...
        
        {
            ...
            result_peg_406 = rule_identifier(stream, result_peg_406.getPosition());
                if (result_peg_406.error()){
                    goto out_peg_408;
                }
                name = result_peg_406.getValues();
            ...
            
            {
                    ...
                    do{
                        Result result_peg_423(result_peg_406.getPosition());
                        {
                            int position_peg_426 = result_peg_423.getPosition();
                            
                            result_peg_423.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_423.getPosition()))){
                                    result_peg_423.nextPosition();
                                } else {
                                    result_peg_423.setPosition(position_peg_426);
                                    goto out_peg_427;
                                }
                            }
                        ...
                        out_peg_427:
                        {
                            int position_peg_429 = result_peg_423.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_423.getPosition()))){
                                    ...
                                    result_peg_423.setPosition(position_peg_429);
                                    goto out_peg_430;
                                }
                            }
                        ...
                        success_peg_424:
                        ;
                        result_peg_406.addResult(result_peg_423);
                    } while (true);
                    loop_peg_422:
                    ;
            ...
            {
                    int position_peg_435 = result_peg_406.getPosition();
                    
                    result_peg_406.reset();
                    do{
                        Result result_peg_446(result_peg_406.getPosition());
                        {
                            int position_peg_449 = result_peg_446.getPosition();
                            
                            result_peg_446.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_446.getPosition()))){
                                    result_peg_446.nextPosition();
                                } else {
                                    result_peg_446.setPosition(position_peg_449);
                                    goto out_peg_450;
                                }
                            }
                        ...
                        out_peg_450:
                        {
                            int position_peg_452 = result_peg_446.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_446.getPosition()))){
                                    ...
                                    result_peg_446.setPosition(position_peg_452);
                                    goto out_peg_453;
                                }
                            }
                        ...
                        success_peg_447:
                        ;
                        result_peg_406.addResult(result_peg_446);
                    } while (true);
                    loop_peg_445:
                    ;
            ...
            result_peg_406 = rule_expr(stream, result_peg_406.getPosition());
                if (result_peg_406.error()){
                    goto out_peg_408;
                }
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_406;
        stream.update(result_peg_406.getPosition());
        
        
        return result_peg_406;
        out_peg_408:
        Result result_peg_455(myposition);
        
        {
        
            result_peg_455 = rule_identifier(stream, result_peg_455.getPosition());
                if (result_peg_455.error()){
                    goto out_peg_457;
                }
                name = result_peg_455.getValues();
            
            
            
            {
                    int position_peg_461 = result_peg_455.getPosition();
                    
                    result_peg_455.reset();
                    do{
                        Result result_peg_472(result_peg_455.getPosition());
                        {
                        ...
                        success_peg_473:
                        ;
                        result_peg_455.addResult(result_peg_472);
                    } while (true);
                    loop_peg_471:
                    ;
            ...
            result_peg_455.setValue(Value((void*) "="));
                for (int i = 0; i < 1; i++){
            ...
            result_peg_455 = rule_whitespace(stream, result_peg_455.getPosition());
                if (result_peg_455.error()){
                    goto out_peg_457;
                }
            ...
            Result result_peg_483(result_peg_455.getPosition());
                result_peg_483 = rule_line_end(stream, result_peg_483.getPosition());
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_455;
        stream.update(result_peg_455.getPosition());
        
        
        return result_peg_455;
        out_peg_457:
        Result result_peg_484(myposition);
        
        {
        
            result_peg_484 = rule_identifier(stream, result_peg_484.getPosition());
                if (result_peg_484.error()){
                    goto out_peg_486;
                }
                name = result_peg_484.getValues();
            
            
            
            {
                    int position_peg_490 = result_peg_484.getPosition();
                    
                    result_peg_484.reset();
                    do{
                        Result result_peg_501(result_peg_484.getPosition());
                        {
                            int position_peg_504 = result_peg_501.getPosition();
                            
                            result_peg_501.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_501.getPosition()))){
                                    result_peg_501.nextPosition();
                                } else {
                                    result_peg_501.setPosition(position_peg_504);
                                    goto out_peg_505;
                                }
                            }
                        ...
                        out_peg_505:
                        {
                            int position_peg_507 = result_peg_501.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_501.getPosition()))){
                                    ...
                                    result_peg_501.setPosition(position_peg_507);
                                    goto out_peg_508;
                                }
                            }
                        ...
                        success_peg_502:
                        ;
                        result_peg_484.addResult(result_peg_501);
                    } while (true);
                    loop_peg_500:
                    ;
                            
                }
                goto success_peg_488;
                goto out_peg_486;
                success_peg_488:
                ;
            ...
            result_peg_484.setValue(Value((void*) "("));
                for (int i = 0; i < 1; i++){
                    if (compareChar("("[i], stream.get(result_peg_484.getPosition()))){
            ...
            {
                    int position_peg_513 = result_peg_484.getPosition();
                    
                    result_peg_484.reset();
                    do{
                        Result result_peg_524(result_peg_484.getPosition());
                        {
                            int position_peg_527 = result_peg_524.getPosition();
                            
                            result_peg_524.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_524.getPosition()))){
                                    result_peg_524.nextPosition();
                                } else {
                                    result_peg_524.setPosition(position_peg_527);
                                    goto out_peg_528;
                                }
                            }
                        ...
                        out_peg_528:
                        {
                            int position_peg_530 = result_peg_524.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_524.getPosition()))){
                                    ...
                                    result_peg_524.setPosition(position_peg_530);
                                    goto out_peg_531;
                                }
                            }
                        ...
                        success_peg_525:
                        ;
                        result_peg_484.addResult(result_peg_524);
                    } while (true);
                    loop_peg_523:
                    ;
            ...
            result_peg_484 = rule_integer(stream, result_peg_484.getPosition());
                if (result_peg_484.error()){
                    goto out_peg_486;
                }
                index = result_peg_484.getValues();
            
            
            
            {
                    int position_peg_536 = result_peg_484.getPosition();
                    
                    result_peg_484.reset();
                    do{
                        Result result_peg_547(result_peg_484.getPosition());
                        {
                        ...
                        success_peg_548:
                        ;
                        result_peg_484.addResult(result_peg_547);
                    } while (true);
                    loop_peg_546:
                    ;
            ...
            {
                    int position_peg_559 = result_peg_484.getPosition();
                    
                    result_peg_484.reset();
                    do{
                        Result result_peg_570(result_peg_484.getPosition());
                        {
                            int position_peg_573 = result_peg_570.getPosition();
                            
                            result_peg_570.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_570.getPosition()))){
                                    result_peg_570.nextPosition();
                                } else {
                                    result_peg_570.setPosition(position_peg_573);
                                    goto out_peg_574;
                                }
                            }
                        ...
                        out_peg_574:
                        {
                            int position_peg_576 = result_peg_570.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_570.getPosition()))){
                                    ...
                                    result_peg_570.setPosition(position_peg_576);
                                    goto out_peg_577;
                                }
                            }
                        ...
                        success_peg_571:
                        ;
                        result_peg_484.addResult(result_peg_570);
                    } while (true);
                    loop_peg_569:
                    ;
                            
                }
                goto success_peg_557;
                goto out_peg_486;
                success_peg_557:
                ;
            ...
            {
                    int position_peg_582 = result_peg_484.getPosition();
                    
                    result_peg_484.reset();
                    do{
                        Result result_peg_593(result_peg_484.getPosition());
                        {
                            int position_peg_596 = result_peg_593.getPosition();
                            
                            result_peg_593.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_593.getPosition()))){
                                    result_peg_593.nextPosition();
                                } else {
                                    result_peg_593.setPosition(position_peg_596);
                                    goto out_peg_597;
                                }
                            }
                        ...
                        out_peg_597:
                        {
                            int position_peg_599 = result_peg_593.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_593.getPosition()))){
                                    ...
                                    result_peg_593.setPosition(position_peg_599);
                                    goto out_peg_600;
                                }
                            }
                        ...
                        success_peg_594:
                        ;
                        result_peg_484.addResult(result_peg_593);
                    } while (true);
                    loop_peg_592:
                    ;
            ...
            result_peg_484 = rule_expr(stream, result_peg_484.getPosition());
                if (result_peg_484.error()){
                    goto out_peg_486;
                }
                exp = result_peg_484.getValues();
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_484;
        stream.update(result_peg_484.getPosition());
        
        
        return result_peg_484;
        out_peg_486:
        Result result_peg_602(myposition);
        
        {
        
            result_peg_602.setValue(Value((void*) "ctrl"));
                for (int i = 0; i < 4; i++){
                    if (compareCharCase("ctrl"[i], stream.get(result_peg_602.getPosition()))){
        ...
        column_peg_1.chunk1->chunk_assignment = result_peg_602;
        stream.update(result_peg_602.getPosition());
        
        
        return result_peg_602;
        out_peg_604:
...
Result rule_function(Stream & stream, const int position){
    ...
    Result result_peg_2(myposition);
        ...
        
        {
            ...
            {
                    int position_peg_375 = result_peg_275.getPosition();
                    
                    result_peg_275.reset();
                    do{
                        Result result_peg_386(result_peg_275.getPosition());
                        {
                            int position_peg_389 = result_peg_386.getPosition();
                            
                            result_peg_386.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_386.getPosition()))){
                                    result_peg_386.nextPosition();
                                } else {
                                    result_peg_386.setPosition(position_peg_389);
                                    goto out_peg_390;
                                }
                            }
                                
                        }
                        goto success_peg_387;
                        out_peg_390:
                        {
                            int position_peg_392 = result_peg_386.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_386.getPosition()))){
                                    ...
                                    result_peg_386.setPosition(position_peg_392);
                                    goto out_peg_393;
                                }
                            }
                        ...
                        success_peg_387:
                        ;
                        result_peg_275.addResult(result_peg_386);
                    } while (true);
                    loop_peg_385:
                    ;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_397 = stream.getLineInfo(result_peg_395.getPosition());
                line = &line_info_peg_397;
            
            
            
            result_peg_395.setValue(Value((void*) "animelem"));
                for (int i = 0; i < 8; i++){
                    if (compareCharCase("animelem"[i], stream.get(result_peg_395.getPosition()))){
            ...
            {
                    int position_peg_403 = result_peg_395.getPosition();
                    
                    result_peg_395.reset();
                    do{
                        Result result_peg_414(result_peg_395.getPosition());
                        {
                            int position_peg_417 = result_peg_414.getPosition();
                            
                            result_peg_414.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_414.getPosition()))){
                                    result_peg_414.nextPosition();
                                } else {
                                    result_peg_414.setPosition(position_peg_417);
                                    goto out_peg_418;
                                }
                            }
                        ...
                        out_peg_418:
                        {
                            int position_peg_420 = result_peg_414.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_414.getPosition()))){
                                    ...
                                    result_peg_414.setPosition(position_peg_420);
                                    goto out_peg_421;
                                }
                            }
                        ...
                        success_peg_415:
                        ;
                        result_peg_395.addResult(result_peg_414);
                    } while (true);
                    loop_peg_413:
                    ;
            ...
            result_peg_395 = rule_all_compare(stream, result_peg_395.getPosition());
            ...
            {
                    int position_peg_426 = result_peg_395.getPosition();
                    
                    result_peg_395.reset();
                    do{
                        Result result_peg_437(result_peg_395.getPosition());
                        {
                            int position_peg_440 = result_peg_437.getPosition();
                            
                            result_peg_437.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_437.getPosition()))){
                                    result_peg_437.nextPosition();
                                } else {
                                    result_peg_437.setPosition(position_peg_440);
                                    goto out_peg_441;
                                }
                            }
                        ...
                        out_peg_441:
                        {
                            int position_peg_443 = result_peg_437.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_437.getPosition()))){
                                    ...
                                    result_peg_437.setPosition(position_peg_443);
                                    goto out_peg_444;
                                }
                            }
                        ...
                        success_peg_438:
                        ;
                        result_peg_395.addResult(result_peg_437);
                    } while (true);
                    loop_peg_436:
                    ;
            ...
            result_peg_395 = rule_integer(stream, result_peg_395.getPosition());
                if (result_peg_395.error()){
                    goto out_peg_399;
                }
                arg1 = result_peg_395.getValues();
        ...
        column_peg_1.chunk8->chunk_function = result_peg_395;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_448 = stream.getLineInfo(result_peg_446.getPosition());
                line = &line_info_peg_448;
            
            
            
            result_peg_446.setValue(Value((void*) "timemod"));
                for (int i = 0; i < 7; i++){
                    if (compareCharCase("timemod"[i], stream.get(result_peg_446.getPosition()))){
                        result_peg_446.nextPosition();
                    } else {
                        goto out_peg_450;
                    }
            ...
            {
                    int position_peg_454 = result_peg_446.getPosition();
                    
                    result_peg_446.reset();
                    do{
                        Result result_peg_465(result_peg_446.getPosition());
                        {
                            int position_peg_468 = result_peg_465.getPosition();
                            
                            result_peg_465.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_465.getPosition()))){
                                    result_peg_465.nextPosition();
                                } else {
                                    result_peg_465.setPosition(position_peg_468);
                                    goto out_peg_469;
                                }
                            }
                                
                        }
                        goto success_peg_466;
                        out_peg_469:
                        {
                            int position_peg_471 = result_peg_465.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_465.getPosition()))){
                                    ...
                                    result_peg_465.setPosition(position_peg_471);
                                    goto out_peg_472;
                                }
                            }
                        ...
                        success_peg_466:
                        ;
                        result_peg_446.addResult(result_peg_465);
                    } while (true);
                    loop_peg_464:
                    ;
            ...
            result_peg_446 = rule_all_compare(stream, result_peg_446.getPosition());
                if (result_peg_446.error()){
                    goto out_peg_450;
                }
                compare = result_peg_446.getValues();
            
            
            
            {
                    int position_peg_477 = result_peg_446.getPosition();
                    
                    result_peg_446.reset();
                    do{
                        Result result_peg_488(result_peg_446.getPosition());
                        {
                            int position_peg_491 = result_peg_488.getPosition();
                            
                            result_peg_488.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_488.getPosition()))){
                                    result_peg_488.nextPosition();
                                } else {
                                    result_peg_488.setPosition(position_peg_491);
                                    goto out_peg_492;
                                }
                            }
                                
                        }
                        goto success_peg_489;
                        out_peg_492:
                        {
                        ...
                        success_peg_489:
                        ;
                        result_peg_446.addResult(result_peg_488);
                    } while (true);
                    loop_peg_487:
                    ;
            ...
            result_peg_446 = rule_integer(stream, result_peg_446.getPosition());
                if (result_peg_446.error()){
                    goto out_peg_450;
                }
                mod = result_peg_446.getValues();
            
            
            
            {
                    int position_peg_500 = result_peg_446.getPosition();
                    
                    result_peg_446.reset();
                    do{
                        Result result_peg_511(result_peg_446.getPosition());
                        {
                            int position_peg_514 = result_peg_511.getPosition();
                            
                            result_peg_511.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_511.getPosition()))){
                                    result_peg_511.nextPosition();
                                } else {
                                    result_peg_511.setPosition(position_peg_514);
                                    goto out_peg_515;
                                }
                            }
                                
                        }
                        goto success_peg_512;
                        out_peg_515:
                        {
                            int position_peg_517 = result_peg_511.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_511.getPosition()))){
                                    ...
                                    result_peg_511.setPosition(position_peg_517);
                                    goto out_peg_518;
                                }
                            }
                        ...
                        success_peg_512:
                        ;
                        result_peg_446.addResult(result_peg_511);
                    } while (true);
                    loop_peg_510:
                    ;
            ...
            {
                    int position_peg_523 = result_peg_446.getPosition();
                    
                    result_peg_446.reset();
                    do{
                        Result result_peg_534(result_peg_446.getPosition());
                        {
                            int position_peg_537 = result_peg_534.getPosition();
                            
                            result_peg_534.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_534.getPosition()))){
                                    result_peg_534.nextPosition();
                                } else {
                                    result_peg_534.setPosition(position_peg_537);
                                    goto out_peg_538;
                                }
                            }
                                
                        }
                        goto success_peg_535;
                        out_peg_538:
                        {
                            int position_peg_540 = result_peg_534.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_534.getPosition()))){
                                    ...
                                    result_peg_534.setPosition(position_peg_540);
                                    goto out_peg_541;
                                }
                            }
                        ...
                        success_peg_535:
                        ;
                        result_peg_446.addResult(result_peg_534);
                    } while (true);
                    loop_peg_533:
                    ;
                            
                }
                goto success_peg_521;
                goto out_peg_450;
                success_peg_521:
                ;
            ...
            int save_peg_543 = result_peg_446.getPosition();
                
                result_peg_446 = rule_all_compare(stream, result_peg_446.getPosition());
                if (result_peg_446.error()){
                    
                    result_peg_446 = Result(save_peg_543);
                    result_peg_446.setValue(Value((void*) 0));
            ...
            {
                    int position_peg_547 = result_peg_446.getPosition();
                    
                    result_peg_446.reset();
                    do{
                        Result result_peg_558(result_peg_446.getPosition());
                        {
                            int position_peg_561 = result_peg_558.getPosition();
                            
                            result_peg_558.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_558.getPosition()))){
                                    result_peg_558.nextPosition();
                                } else {
                                    result_peg_558.setPosition(position_peg_561);
                                    goto out_peg_562;
                                }
                            }
                        ...
                        out_peg_562:
                        {
                            int position_peg_564 = result_peg_558.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_558.getPosition()))){
                                    ...
                                    result_peg_558.setPosition(position_peg_564);
                                    goto out_peg_565;
                                }
                            }
                        ...
                        success_peg_559:
                        ;
                        result_peg_446.addResult(result_peg_558);
                    } while (true);
                    loop_peg_557:
                    ;
                            
                }
                goto success_peg_545;
                goto out_peg_450;
                success_peg_545:
                ;
        ...
        column_peg_1.chunk8->chunk_function = result_peg_446;
        ...
        
        {
            ...
            Stream::LineInfo line_info_peg_569 = stream.getLineInfo(result_peg_567.getPosition());
                line = &line_info_peg_569;
            
            
            
            {
                    int position_peg_573 = result_peg_567.getPosition();
                    
                    result_peg_567.setValue(Value((void*) "projhit"));
                    for (int i = 0; i < 7; i++){
                        if (compareCharCase("projhit"[i], stream.get(result_peg_567.getPosition()))){
                            result_peg_567.nextPosition();
                        } else {
                            result_peg_567.setPosition(position_peg_573);
                            goto out_peg_574;
                        }
                    }
                ...
                out_peg_574:
                {
                    int position_peg_576 = result_peg_567.getPosition();
                    
                    result_peg_567.setValue(Value((void*) "projcontact"));
                    for (int i = 0; i < 11; i++){
                        if (compareCharCase("projcontact"[i], stream.get(result_peg_567.getPosition()))){
                            result_peg_567.nextPosition();
                        } else {
                            result_peg_567.setPosition(position_peg_576);
                            goto out_peg_577;
                        }
                    }
                ...
                success_peg_571:
                ;
                name = result_peg_567.getValues();
            
            
            
            int save_peg_580 = result_peg_567.getPosition();
                
                result_peg_567 = rule_integer(stream, result_peg_567.getPosition());
                if (result_peg_567.error()){
                    
                    result_peg_567 = Result(save_peg_580);
                    result_peg_567.setValue(Value((void*) 0));
                    
                }
                id = result_peg_567.getValues();
            
            
            
            {
                    int position_peg_584 = result_peg_567.getPosition();
                    
                    result_peg_567.reset();
                    do{
                        Result result_peg_595(result_peg_567.getPosition());
                        {
                            int position_peg_598 = result_peg_595.getPosition();
                            
                            result_peg_595.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_595.getPosition()))){
                                    result_peg_595.nextPosition();
                                } else {
                                    result_peg_595.setPosition(position_peg_598);
                                    goto out_peg_599;
                                }
                            }
                        ...
                        out_peg_599:
                        {
                            int position_peg_601 = result_peg_595.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_595.getPosition()))){
                                    ...
                                    result_peg_595.setPosition(position_peg_601);
                                    goto out_peg_602;
                                }
                            }
                        ...
                        success_peg_596:
                        ;
                        result_peg_567.addResult(result_peg_595);
                    } while (true);
                    loop_peg_594:
                    ;
                            
                }
                goto success_peg_582;
                goto out_peg_578;
                success_peg_582:
                ;
            ...
            result_peg_567.setValue(Value((void*) "="));
                for (int i = 0; i < 1; i++){
            ...
            {
                    int position_peg_607 = result_peg_567.getPosition();
                    
                    result_peg_567.reset();
                    do{
                        Result result_peg_618(result_peg_567.getPosition());
                        {
                            int position_peg_621 = result_peg_618.getPosition();
                            
                            result_peg_618.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_618.getPosition()))){
                                    result_peg_618.nextPosition();
                                } else {
                                    result_peg_618.setPosition(position_peg_621);
                                    goto out_peg_622;
                                }
                            }
                        ...
                        out_peg_622:
                        {
                            int position_peg_624 = result_peg_618.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_618.getPosition()))){
                                    ...
                                    result_peg_618.setPosition(position_peg_624);
                                    goto out_peg_625;
                                }
                            }
                        ...
                        success_peg_619:
                        ;
                        result_peg_567.addResult(result_peg_618);
                    } while (true);
                    loop_peg_617:
                    ;
            ...
            result_peg_567 = rule_integer(stream, result_peg_567.getPosition());
                ...
                arg1 = result_peg_567.getValues();
            
            
            
            int save_peg_628 = result_peg_567.getPosition();
                {
                
                    {
                            int position_peg_632 = result_peg_567.getPosition();
                            
                            result_peg_567.reset();
                            do{
                                Result result_peg_643(result_peg_567.getPosition());
                                {
                                    int position_peg_646 = result_peg_643.getPosition();
                                    
                                    result_peg_643.setValue(Value((void*) " "));
                                    for (int i = 0; i < 1; i++){
                                        if (compareChar(" "[i], stream.get(result_peg_643.getPosition()))){
                                            result_peg_643.nextPosition();
                                        } else {
                                            result_peg_643.setPosition(position_peg_646);
                                            goto out_peg_647;
                                        }
                                    }
                                ...
                                out_peg_647:
                                {
                                    int position_peg_649 = result_peg_643.getPosition();
                                    ...
                                    for (int i = 0; i < 1; i++){
                                        if (compareChar("\t"[i], stream.get(result_peg_643.getPosition()))){
                                            ...
                                            result_peg_643.setPosition(position_peg_649);
                                            goto out_peg_650;
                                        }
                                    }
                                ...
                                success_peg_644:
                                ;
                                result_peg_567.addResult(result_peg_643);
                            } while (true);
                            loop_peg_642:
                            ;
                        ...
                        result_peg_567 = Result(save_peg_628);
                        result_peg_567.setValue(Value((void*) 0));
                    ...
                    {
                            int position_peg_655 = result_peg_567.getPosition();
                            
                            result_peg_567.reset();
                            do{
                                Result result_peg_666(result_peg_567.getPosition());
                                {
                                    int position_peg_669 = result_peg_666.getPosition();
                                    
                                    result_peg_666.setValue(Value((void*) " "));
                                    for (int i = 0; i < 1; i++){
                                        if (compareChar(" "[i], stream.get(result_peg_666.getPosition()))){
                                            result_peg_666.nextPosition();
                                        } else {
                                            result_peg_666.setPosition(position_peg_669);
                                            goto out_peg_670;
                                        }
                                    }
                                ...
                                out_peg_670:
                                {
                                    int position_peg_672 = result_peg_666.getPosition();
                                    ...
                                    for (int i = 0; i < 1; i++){
                                        if (compareChar("\t"[i], stream.get(result_peg_666.getPosition()))){
                                            ...
                                            result_peg_666.setPosition(position_peg_672);
                                            goto out_peg_673;
                                        }
                                    }
                                ...
                                success_peg_667:
                                ;
                                result_peg_567.addResult(result_peg_666);
                            } while (true);
                            loop_peg_665:
                            ;
                                    
                        }
                        goto success_peg_653;
                    ...
                    result_peg_567 = rule_all_compare(stream, result_peg_567.getPosition());
                        if (result_peg_567.error()){
                        ...
                        compare = result_peg_567.getValues();
                    
                    
                    
                    {
                            int position_peg_678 = result_peg_567.getPosition();
                            
                            result_peg_567.reset();
                            do{
                                Result result_peg_689(result_peg_567.getPosition());
                                {
                                    int position_peg_692 = result_peg_689.getPosition();
                                    
                                    result_peg_689.setValue(Value((void*) " "));
                                    for (int i = 0; i < 1; i++){
                                        if (compareChar(" "[i], stream.get(result_peg_689.getPosition()))){
                                            result_peg_689.nextPosition();
                                        } else {
                                            result_peg_689.setPosition(position_peg_692);
                                            goto out_peg_693;
                                        }
                                    }
                                ...
                                out_peg_693:
                                {
                                    int position_peg_695 = result_peg_689.getPosition();
                                    ...
                                    for (int i = 0; i < 1; i++){
                                        if (compareChar("\t"[i], stream.get(result_peg_689.getPosition()))){
                                            ...
                                            result_peg_689.setPosition(position_peg_695);
                                            goto out_peg_696;
                                        }
                                    }
                                ...
                                success_peg_690:
                                ;
                                result_peg_567.addResult(result_peg_689);
                            } while (true);
                            loop_peg_688:
                            ;
                    ...
                    result_peg_567 = rule_value(stream, result_peg_567.getPosition());
                        if (result_peg_567.error()){
                        ...
                        ticks = result_peg_567.getValues();
        ...
        column_peg_1.chunk8->chunk_function = result_peg_567;
        ...
        
        {
            ...
            result_peg_697.setValue(Value((void*) "hitdefattr"));
                for (int i = 0; i < 10; i++){
                    if (compareCharCase("hitdefattr"[i], stream.get(result_peg_697.getPosition()))){
            ...
            {
                    int position_peg_703 = result_peg_697.getPosition();
                    
                    result_peg_697.reset();
                    do{
                        Result result_peg_714(result_peg_697.getPosition());
                        {
                            int position_peg_717 = result_peg_714.getPosition();
                            
                            result_peg_714.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_714.getPosition()))){
                                    result_peg_714.nextPosition();
                                } else {
                                    result_peg_714.setPosition(position_peg_717);
                                    goto out_peg_718;
                                }
                            }
                        ...
                        out_peg_718:
                        {
                            int position_peg_720 = result_peg_714.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_714.getPosition()))){
                                    ...
                                    result_peg_714.setPosition(position_peg_720);
                                    goto out_peg_721;
                                }
                            }
                        ...
                        success_peg_715:
                        ;
                        result_peg_697.addResult(result_peg_714);
                    } while (true);
                    loop_peg_713:
                    ;
            ...
            {
                    int position_peg_725 = result_peg_697.getPosition();
                    {
                    
                        result_peg_697.setValue(Value((void*) "="));
                            for (int i = 0; i < 1; i++){
                                if (compareChar("="[i], stream.get(result_peg_697.getPosition()))){
                                    result_peg_697.nextPosition();
                                } else {
                                    result_peg_697.setPosition(position_peg_725);
                                    goto out_peg_727;
                                }
                            }
                ...
                out_peg_727:
                {
                    int position_peg_730 = result_peg_697.getPosition();
                    {
                        ...
                        result_peg_697.setValue(Value((void*) "!="));
                            for (int i = 0; i < 2; i++){
                                if (compareChar("!="[i], stream.get(result_peg_697.getPosition()))){
                                    ...
                                    result_peg_697.setPosition(position_peg_730);
                                    goto out_peg_732;
                                }
                            }
                ...
                success_peg_723:
                ;
                comparison = result_peg_697.getValues();
            
            
            
            {
                    int position_peg_737 = result_peg_697.getPosition();
                    
                    result_peg_697.reset();
                    do{
                        Result result_peg_748(result_peg_697.getPosition());
                        {
                            int position_peg_751 = result_peg_748.getPosition();
                            
                            result_peg_748.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_748.getPosition()))){
                                    result_peg_748.nextPosition();
                                } else {
                                    result_peg_748.setPosition(position_peg_751);
                                    goto out_peg_752;
                                }
                            }
                                
                        }
                        goto success_peg_749;
                        out_peg_752:
                        {
                            int position_peg_754 = result_peg_748.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_748.getPosition()))){
                                    ...
                                    result_peg_748.setPosition(position_peg_754);
                                    goto out_peg_755;
                                }
                            }
                        ...
                        success_peg_749:
                        ;
                        result_peg_697.addResult(result_peg_748);
                    } while (true);
                    loop_peg_747:
                    ;
                            
                }
                goto success_peg_735;
                goto out_peg_699;
                success_peg_735:
                ;
            ...
            result_peg_697 = rule_hitdef__attribute(stream, result_peg_697.getPosition());
                if (result_peg_697.error()){
                    goto out_peg_699;
                }
                state = result_peg_697.getValues();
            
            
            
            {
                    int position_peg_760 = result_peg_697.getPosition();
                    
                    result_peg_697.reset();
                    do{
                        Result result_peg_771(result_peg_697.getPosition());
                        {
                            int position_peg_774 = result_peg_771.getPosition();
                            
                            result_peg_771.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_771.getPosition()))){
                                    result_peg_771.nextPosition();
                                } else {
                                    result_peg_771.setPosition(position_peg_774);
                                    goto out_peg_775;
                                }
                            }
                        ...
                        out_peg_775:
                        {
                            int position_peg_777 = result_peg_771.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_771.getPosition()))){
                                    ...
                                    result_peg_771.setPosition(position_peg_777);
                                    goto out_peg_778;
                                }
                            }
                        ...
                        success_peg_772:
                        ;
                        result_peg_697.addResult(result_peg_771);
                    } while (true);
                    loop_peg_770:
                    ;
            ...
            {
                    int position_peg_783 = result_peg_697.getPosition();
                    
                    result_peg_697.reset();
                    do{
                        Result result_peg_794(result_peg_697.getPosition());
                        {
                            int position_peg_797 = result_peg_794.getPosition();
                            
                            result_peg_794.setValue(Value((void*) " "));
                            for (int i = 0; i < 1; i++){
                                if (compareChar(" "[i], stream.get(result_peg_794.getPosition()))){
                                    result_peg_794.nextPosition();
                                } else {
                                    result_peg_794.setPosition(position_peg_797);
                                    goto out_peg_798;
                                }
                            }
                        ...
                        out_peg_798:
                        {
                            int position_peg_800 = result_peg_794.getPosition();
                            ...
                            for (int i = 0; i < 1; i++){
                                if (compareChar("\t"[i], stream.get(result_peg_794.getPosition()))){
                                    ...
                                    result_peg_794.setPosition(position_peg_800);
                                    goto out_peg_801;
                                }
                            }
                        ...
                        success_peg_795:
                        ;
                        result_peg_697.addResult(result_peg_794);
                    } while (true);
                    loop_peg_793:
                    ;
            ...
            result_peg_697 = rule_hitdef__attack__attribute(stream, result_peg_697.getPosition());
                if (result_peg_697.error()){
                    goto out_peg_699;
                }
                attributes = result_peg_697.getValues();
        ...
        column_peg_1.chunk8->chunk_function = result_peg_697;
...
Result rule_key_value_list(Stream & stream, const int position){
    ...
    RuleTrace trace_peg_55(stream, "key_value_list");
    int myposition = position;
    ...
    Result result_peg_2(myposition);
        ...
        column_peg_1.chunk10->chunk_key_value_list = result_peg_53;
        stream.update(result_peg_53.getPosition());
...
Result rule_value(Stream & stream, const int position){
    ...
    RuleTrace trace_peg_47(stream, "value");
    int myposition = position;
    ...
    Result result_peg_2(myposition);
        ...
        column_peg_1.chunk11->chunk_value = result_peg_13;
        stream.update(result_peg_13.getPosition());
        ...
        {
            int position_peg_18 = result_peg_15.getPosition();
            {
                ...
                result_peg_15.setValue(Value((void*) "\""));
                    for (int i = 0; i < 1; i++){
                        if (compareChar("\""[i], stream.get(result_peg_15.getPosition()))){
                            ...
                            result_peg_15.setPosition(position_peg_18);
                            goto out_peg_20;
                        }
                    }
                ...
                result_peg_15.reset();
                    do{
                        Result result_peg_35(result_peg_15.getPosition());
                        {
                            ...
                            Result result_peg_41(result_peg_35);
                                result_peg_41.setValue(Value((void*) "\n"));
                                for (int i = 0; i < 1; i++){
                            ...
                            char temp_peg_42 = stream.get(result_peg_35.getPosition());
                                if (temp_peg_42 != '\0'){
                                    result_peg_35.setValue(Value((void*) (long) temp_peg_42));
                        ...
                        result_peg_15.addResult(result_peg_35);
                    } while (true);
                    loop_peg_34:
                    ;
                    contents = result_peg_15.getValues();
        ...
        result_peg_45 = rule_hitflag(stream, result_peg_45.getPosition());
        ...
        column_peg_1.chunk11->chunk_value = result_peg_45;
...
Result rule_helper__expression(Stream & stream, const int position){
    ...
    RuleTrace trace_peg_50(stream, "helper__expression");
    int myposition = position;
...
Result rule_helper__identifier(Stream & stream, const int position){
    ...
    Column & column_peg_1 = stream.getColumn(position);
    if (column_peg_1.chunk11 != 0 && column_peg_1.chunk11->chunk_helper__identifier.calculated()){
        return column_peg_1.chunk11->chunk_helper__identifier;
    }
    ...
    Result result_peg_2(myposition);
        ...
        column_peg_1.chunk11->chunk_helper__identifier = result_peg_2;
        stream.update(result_peg_2.getPosition());
        ...
        column_peg_1.chunk11->chunk_helper__identifier = result_peg_4;
        stream.update(result_peg_4.getPosition());
        ...
        column_peg_1.chunk11->chunk_helper__identifier = result_peg_6;
        stream.update(result_peg_6.getPosition());
        ...
        column_peg_1.chunk11->chunk_helper__identifier = errorResult;
        stream.update(errorResult.getPosition());
